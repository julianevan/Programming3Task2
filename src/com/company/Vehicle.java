...
public abstract class Vehicle {
    ...
    public void move(){
        ...
        float nextPosition = position + length + speed;
        ...
        if (speed == STOPPED){}
        else if(!currentRoad.getLightsOnRoad().isEmpty() && nextPosition + 1 >= currentRoad.getLightsOnRoad().get(0).getPosition() && this.currentRoad.getLightsOnRoad().get(0).getState().equals("red")){
            speed = STOPPED;
        }
        else {
            speed = currentRoad.getSpeedLimit();
